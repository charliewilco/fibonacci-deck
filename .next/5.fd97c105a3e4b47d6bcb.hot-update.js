...
var fib = Array(12).fill();
console.log(fib);
var data = [{
  color: color[0],
  value: __WEBPACK_IMPORTED_MODULE_3_fib___default()(1),
  display: __WEBPACK_IMPORTED_MODULE_3_fib___default()(1)
}]; // const Head = ({ color }) => (
//   <Helmet>
...
//# sourceMappingURL=5.fd97c105a3e4b47d6bcb.hot-update.js.map